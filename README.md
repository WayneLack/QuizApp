# QuizApp
 The purpose of this project is initially to develop a basic quiz app in python and gain some familiarity with TKinter and classes in 
python.

Below I outline the vague longer term plans, though the exact journey will depend on what I feel will help me develop useful coding 
skills at the time, so this may change. 
 - Phase 1 is to add way more questions so I can actually get quizin
 - Phase 2 is to neaten up the way it looks a bit more, features like changing the size of the window not messing it up, colour schemes, and general positioning of buttons
 ...
 - Phase 6 is the add app like features, since it will now be app-like. Things like a scoreboard, in-game achievements, adverts, and the ability to share on your facebook 
	so your nan can see
 - Phase 7 is of course to make millions on the app store
